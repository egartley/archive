...
$(document).ready(function() {
	...
	if (null != query && "" != query) {
		$("input#query").val(query); // set text of textbox to the "?q=" URL variable
		go(query);
	}
});
...
function fetchSearchJSON(query) {
	var request = new XMLHttpRequest,
		jsonURL = "https://core-cdn.egartley.net/VLtaWYvbJvGxIWtRVzWXiwQBdZBvBRnE/json/bQBFSuMcCghdoubpglcbfDJtvHrkJlSs/search.json";
