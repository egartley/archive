...
/*  56 */     t2 = (byte)(t2 + 1);
/*  57 */     if (t2 >= 42) {
/*  58 */       Game.getPlayer().takeDamage(2.0D);
/*  59 */       t2 = 0;
/*     */     } 
/*     */   }
/*     */   
...
/*     */       } 
/*     */     } 
/* 186 */     if (Math.sqrt(((rx - (Game.getPlayer()).x) * (rx - (Game.getPlayer()).x) + (ry - (Game.getPlayer()).y) * (
/* 187 */         ry - (Game.getPlayer()).y))) <= attackRadius)
/* 188 */       dealDamage(0.5D); 
/*     */   }
/*     */   
/*     */   public void render(Graphics g) {
/* 194 */     if (!isDead) {
/* 195 */       rx = x - (Game.getPlayer()).mapX + Game.playerSpawnX;
/* 196 */       ry = y - (Game.getPlayer()).mapY + Game.playerSpawnY;
...
/* Location:              E:\Projects\Beyond Origins\BeyondOrigins_0.0.6_4.jar!\beyondOrigins\main\entities\TestDummy.class
