...
/*  29 */     addText(64, 39, 100, 22, "Profile Name:");
/*  30 */     this.proName = new JTextField();
/*  31 */     this.proName.setBounds(64, 64, 156, 22);
/*  32 */     add(this.proName);
/*  34 */     addText(64, 192, 175, 22, "Player Name (Cannot change):");
/*  35 */     this.plrName = new JTextField();
/*  36 */     this.plrName.setBounds(64, 220, 156, 22);
/*  37 */     add(this.plrName);
/*  39 */     addButton(186, 423, "Create");
/*     */   }
/*     */   
/*     */   private void addTextField(int x, int y, String text) {
/*  43 */     JTextField tf = new JTextField();
/*  44 */     tf.setText(text);
/*  45 */     tf.setBounds(x, y, 156, 22);
/*  46 */     add(tf);
/*     */   }
/*     */   
...
/* 123 */           Load.loadProfile(Game.save1Path);
...
/* 127 */           Load.loadProfile(Game.save2Path);
...
/* 131 */           Load.loadProfile(Game.save3Path);
/*     */         } 
/* 133 */         Game.getMainMenu().enterGame();
/* 134 */       } catch (IOException ea) {
/* 135 */         ea.printStackTrace();
/*     */       } 
/* 137 */       dispose();
/*     */     } 
/*     */   }
...
/* Location:              E:\Projects\Beyond Origins\BeyondOrigins_0.0.6_4.jar!\beyondOrigins\main\windows\ProfileCreator.class
