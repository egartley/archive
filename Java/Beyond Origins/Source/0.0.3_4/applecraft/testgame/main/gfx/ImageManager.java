...
/* 72 */     this.cowd3 = ss.crop1(2, 2, 32, 32);
/* 73 */     this.cowd4 = ss.crop1(0, 2, 32, 32);
/* 75 */     this.cowu1 = ss.crop1(0, 3, 32, 32);
/* 76 */     this.cowu2 = ss.crop1(1, 3, 32, 32);
/* 77 */     this.cowu3 = ss.crop1(2, 3, 32, 32);
/* 78 */     this.cowu4 = ss.crop1(0, 3, 32, 32);
/* 80 */     this.cowl1 = ss.crop1(0, 0, 32, 32);
/* 81 */     this.cowl2 = ss.crop1(1, 0, 32, 32);
/* 82 */     this.cowl3 = ss.crop1(2, 0, 32, 32);
/* 83 */     this.cowl4 = ss.crop1(0, 0, 32, 32);
/* 85 */     this.cowr1 = ss.crop1(0, 1, 32, 32);
/* 86 */     this.cowr2 = ss.crop1(1, 1, 32, 32);
/* 87 */     this.cowr3 = ss.crop1(2, 1, 32, 32);
/* 88 */     this.cowr4 = ss.crop1(0, 1, 32, 32);
...
/* Location:              E:\Projects\Beyond Origins\BeyondOrigins_0.0.3_4.jar!\applecraft\testgame\main\gfx\ImageManager.class
