...
/* 213 */     this.ab.createWindow();
/* 214 */     Game.endClick();
/*     */   }
/*     */   
/*     */   private void m4ResetFiles() {
/* 218 */     Save.save1.delete();
/* 219 */     Save.save2.delete();
/* 220 */     Save.save3.delete();
/* 221 */     Save.data.delete();
/* 222 */     Save.keys.delete();
/* 223 */     Save.dataReset();
/* 224 */     Save.profileReset();
/* 225 */     Game.endClick();
/*     */   }
/*     */   
/*     */   private void m4Keys() {
/* 229 */     this.k.createWindow();
/* 230 */     Game.endClick();
/*     */   }
/*     */   
/*     */   private void m4Back() {
/* 234 */     (Game.getMainMenu()).save1State = 0;
/* 235 */     (Game.getMainMenu()).save2State = 0;
/* 236 */     (Game.getMainMenu()).save3State = 0;
/* 237 */     (Game.getMainMenu()).currentProfile = 0;
/* 238 */     (Game.getMainMenu()).menuState = 1;
/* 239 */     Game.endClick();
/*     */   }
/*     */ }


/* Location:              E:\Projects\Beyond Origins\BeyondOrigins_0.0.8_0.jar!\beyondOrigins\main\menus\Options.class
