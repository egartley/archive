...
/*  50 */     Player.playerX = Game.playerSpawnX;
/*  51 */     Player.playerY = Game.playerSpawnY;
/*  52 */     Player.mapX = Game.playerSpawnX;
/*  53 */     Player.mapY = Game.playerSpawnY;
...
/* 142 */     pw1.println(MainMenu.save1Name);
/* 143 */     pw1.println(MainMenu.save2Name);
/* 144 */     pw1.println(MainMenu.save3Name);
/* 145 */     pw1.println(MainMenu.save1Name_backup);
/* 146 */     pw1.println(MainMenu.save2Name_backup);
/* 147 */     pw1.println(MainMenu.save3Name_backup);
/* 148 */     pw1.println(Game.autoSave);
/* 151 */     pw1.close();
/*     */   }
/*     */ }


/* Location:              E:\Projects\Beyond Origins\BeyondOrigins_0.0.5_2.jar!\beyondOrigins\files\Save.class
