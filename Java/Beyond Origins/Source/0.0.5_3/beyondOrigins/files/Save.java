...
/*  58 */     Player.playerX = Game.playerSpawnX;
/*  59 */     Player.playerY = Game.playerSpawnY;
...
/* 114 */     pw1.println(Player.playerX);
/* 115 */     pw1.println(Player.playerY);
...
/* 127 */     if (!data.exists()) {
/* 128 */       fwData = new FileWriter(Game.dataPath);
/* 129 */     } else if (data.exists()) {
/* 130 */       data.delete();
/* 131 */       fwData = new FileWriter(Game.dataPath);
/*     */     } 
/* 135 */     PrintWriter pw1 = new PrintWriter(fwData);
/* 138 */     pw1.println(save1LastPlayed);
/* 139 */     pw1.println(save1Made);
/* 140 */     pw1.println(save2LastPlayed);
/* 141 */     pw1.println(save2Made);
/* 142 */     pw1.println(save3LastPlayed);
/* 143 */     pw1.println(save3Made);
/* 144 */     pw1.println(MainMenu.save1Name);
/* 145 */     pw1.println(MainMenu.save2Name);
/* 146 */     pw1.println(MainMenu.save3Name);
/* 147 */     pw1.println(MainMenu.save1Name_backup);
/* 148 */     pw1.println(MainMenu.save2Name_backup);
/* 149 */     pw1.println(MainMenu.save3Name_backup);
/* 150 */     pw1.println(Game.autoSave);
/* 151 */     pw1.println(Game.testDummy);
/* 154 */     pw1.close();
/*     */   }
/*     */ }


/* Location:              E:\Projects\Beyond Origins\BeyondOrigins_0.0.5_3.jar!\beyondOrigins\files\Save.class
