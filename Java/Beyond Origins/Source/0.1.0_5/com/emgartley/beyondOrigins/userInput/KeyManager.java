...
/* 158 */     if (e.getKeyCode() == Keys.toggleOverview)
/* 159 */       Game.overviewing = !Game.overviewing; 
/* 163 */     if (e.getKeyCode() == Keys.block)
/* 164 */       released_block(); 
/* 168 */     if (e.getKeyCode() == Keys.attack && !Inventory.invOpen)
/* 169 */       (Game.getPlayer()).isAttacking = false; 
/* 173 */     if (e.getKeyCode() == Keys.up)
/* 174 */       released_up(); 
/* 178 */     if (e.getKeyCode() == Keys.down)
/* 179 */       released_down(); 
/* 183 */     if (e.getKeyCode() == Keys.left)
/* 184 */       released_left(); 
/* 188 */     if (e.getKeyCode() == Keys.right)
/* 189 */       released_right(); 
/* 199 */     if (e.getKeyCode() == 27) {
/* 200 */       escPressed = false;
/* 201 */       released_esc();
/*     */     } 
/* 205 */     if (e.getKeyCode() == 10)
/* 206 */       released_enter(); 
/* 210 */     if (e.getKeyCode() == 116)
/* 211 */       Game.loadGfx(); 
/*     */   }
/*     */   
...
/* Location:              E:\Projects\Beyond Origins\BeyondOrigins_0.1.0_5.jar!\com\emgartley\beyondOrigin\\userInput\KeyManager.class
