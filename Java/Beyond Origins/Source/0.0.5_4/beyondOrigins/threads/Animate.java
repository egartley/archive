...
/* 39 */       g.drawImage(frame3, x, y, null); 
/* 41 */     if (count >= 32 && count <= 41)
/* 42 */       g.drawImage(frame4, x, y, null); 
/*    */   }
/*    */ }


/* Location:              E:\Projects\Beyond Origins\BeyondOrigins_0.0.5_4.jar!\beyondOrigins\threads\Animate.class
