...
/* 39 */       g.drawString("FPS: " + Game.currentFrames + " | " + "Current Profile: " + MainMenu.currentProfile, 650, 40);
/* 40 */       g.drawString("MX: " + MouseMotion.mouseX + "  " + "MY: " + 
/* 41 */           MouseMotion.mouseY, 650, 55);
/* 42 */       g.drawString("Save States: " + MainMenu.save1State + MainMenu.save2State + MainMenu.save3State, 650, 70);
/*    */     } 
/*    */   }
/*    */ }


/* Location:              E:\Projects\Beyond Origins\BeyondOrigins_0.0.4.7_1.jar!\beyondOrigins\main\menus\F3Menu.class
