...
/*  60 */     pw1.println(Shop.isInside);
/*  61 */     pw1.println(Shop.enter);
/*  62 */     pw1.println(Shop.exit);
/*  63 */     pw1.println(Shop.overlay);
/*  66 */     pw1.close();
/*     */   }
/*     */   
...
/*  89 */     pw2.println(Shop.isInside);
/*  90 */     pw2.println(Shop.enter);
/*  91 */     pw2.println(Shop.exit);
/*  92 */     pw2.println(Shop.overlay);
/*  95 */     pw2.close();
/*     */   }
/*     */   
...
/* 118 */     pw3.println(Shop.isInside);
/* 119 */     pw3.println(Shop.enter);
/* 120 */     pw3.println(Shop.exit);
/* 121 */     pw3.println(Shop.overlay);
/* 124 */     pw3.close();
/*     */   }
/*     */ }


/* Location:              E:\Projects\Beyond Origins\BeyondOrigins_0.0.4.8.jar!\beyondOrigins\main\Save.class
