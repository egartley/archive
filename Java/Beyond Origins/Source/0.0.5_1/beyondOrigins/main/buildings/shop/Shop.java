...
/*    */   
/*    */   public Shop(ImageManager im) {
/* 23 */     im = im;
/*    */   }
/*    */   
/*    */   public static void tick() {
/* 27 */     if (Player.tileX == 46 && Player.tileY == 3 && (
/* 28 */       Player.isMovingUp || test1 == 1) && enter != 2) {
/* 29 */       enter = 1;
/* 30 */       test1 = 1;
/* 31 */       overlay += 8;
/* 32 */       if (overlay >= 248) {
...
/* 47 */       Player.down || test2 == 1) && exit != 2 && !Player.mapMovement) {
/* 48 */       exit = 1;
/* 49 */       test2 = 1;
/* 50 */       overlay -= 8;
/* 51 */       if (overlay <= 0) {
...
/* Location:              E:\Projects\Beyond Origins\BeyondOrigins_0.0.5_1.jar!\beyondOrigins\main\buildings\shop\Shop.class
