...
/* 318 */     g.drawImage(Game.logoImage, 163, -125, 512, 512, null);
...
/* 569 */         menuState = 5;
/*     */       } 
/* 571 */     } else if (currentProfile == 2) {
/* 572 */       if (Save.save2.exists()) {
/* 573 */         Load.loadProfile(Game.save2Path);
/* 574 */         Save.profileSave(Save.save2, Game.save2Path, 2);
/* 575 */         Save.dataSave();
/* 576 */         Game.isInGame = true;
/* 577 */         menuState = 0;
/* 578 */       } else if (!Save.save2.exists()) {
/* 579 */         menuState = 5;
/*     */       } 
/* 581 */     } else if (currentProfile == 3) {
/* 582 */       if (Save.save3.exists()) {
/* 583 */         Load.loadProfile(Game.save3Path);
/* 584 */         Save.profileSave(Save.save3, Game.save3Path, 3);
/* 585 */         Save.dataSave();
/* 586 */         Game.isInGame = true;
/* 587 */         menuState = 0;
/* 588 */       } else if (!Save.save3.exists()) {
/* 589 */         menuState = 5;
/*     */       } 
/*     */     } 
/* 592 */     save1State = 0;
...
/* 600 */     if (currentProfile == 1) {
/* 601 */       Save.save1.delete();
/* 602 */       Save.save1Made = "";
/* 603 */       Save.save1LastPlayed = "";
/* 604 */       Save.dataSave();
/* 605 */     } else if (currentProfile == 2) {
/* 606 */       Save.save2.delete();
/* 607 */       Save.save2Made = "";
/* 608 */       Save.save2LastPlayed = "";
/* 609 */       Save.dataSave();
/* 610 */     } else if (currentProfile == 3) {
/* 611 */       Save.save3.delete();
/* 612 */       Save.save3Made = " ";
/* 613 */       Save.save3LastPlayed = " ";
/* 614 */       Save.dataSave();
/*     */     } 
/* 617 */     menuState = 2;
/* 618 */     currentProfile = 0;
/*     */   }
/*     */   
...
/* 624 */     save2State = 0;
/* 625 */     save3State = 0;
/* 626 */     currentProfile = 0;
/* 627 */     menuState = 1;
/*     */   }
/*     */   
/*     */   public void menuStateIs3_yes() {
/*     */     try {
/* 633 */       menuStateIs2_deleteProfile();
...
/* 648 */     if (autoSaveToggle == "On") {
/* 649 */       autoSaveToggle = "Off";
/* 650 */       Game.autoSave = false;
/* 651 */     } else if (autoSaveToggle == "Off") {
/* 652 */       autoSaveToggle = "On";
/* 653 */       Game.autoSave = true;
/*     */     } 
/* 655 */     canPressButton = false;
/*     */     try {
/* 657 */       Save.dataSave();
...
/* Location:              E:\Projects\Beyond Origins\BeyondOrigins_0.0.4.9_1.jar!\beyondOrigins\main\menus\MainMenu.class
