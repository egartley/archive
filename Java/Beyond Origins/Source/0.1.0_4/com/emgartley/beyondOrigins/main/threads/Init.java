...
/*  84 */     Game.im = new ImageManager();
/*  85 */     Game.logger.log("Loaded graphics");
/*     */   }
/*     */   
/*     */   private void go() {
/*  89 */     Game.loadingStatus = "Starting up... (1/3)";
/*  90 */     Game.initing = true;
/*  91 */     Game.logger = new Logger();
/*  92 */     Game.logger.log("Game started");
/*  93 */     Game.loadingStatus = "Loading in graphics... (2/3)";
/*  94 */     loadGfx();
/*  95 */     Game.loadingStatus = "Starting classes... (3/3)";
/*  96 */     Game.mainMenu = new MainMenu();
/*  97 */     Game.pauseMenu = new PauseMenu();
/*  98 */     Game.grassm = new GrassMap(Game.mapImage, 0, 0);
/*  99 */     Entity.init();
/* 100 */     Game.inv = new Inventory();
/* 101 */     Game.br = new BuildingRender();
/* 102 */     Game.storyText = new StoryText();
/* 103 */     BuildingRender.init();
/* 104 */     Shop.init();
/* 105 */     Game.loadingStatus = "Done loading!";
/*     */     try {
/* 107 */       Thread.sleep(1200L);
...
/* Location:              E:\Projects\Beyond Origins\BeyondOrigins_0.1.0_4.jar!\com\emgartley\beyondOrigins\main\threads\Init.class
