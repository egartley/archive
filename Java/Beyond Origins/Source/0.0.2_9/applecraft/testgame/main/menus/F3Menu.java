...
/* 29 */       g.drawString("Player X: " + Player.playerX + "   " + "Player Y: " + Player.playerY, 15, 40);
/* 30 */       g.drawString("Tile X: " + Player.tileX + "  " + "Tile Y: " + Player.tileY, 15, 55);
/* 31 */       g.drawString("Map X: " + Player.mapX + "  " + " Map Y: " + Player.mapY, 15, 70);
/* 32 */       g.drawString("Speed: " + Player.SPEED, 15, 85);
...
/* Location:              E:\Projects\Beyond Origins\BeyondOrigins_0.0.2_9.jar!\applecraft\testgame\main\menus\F3Menu.class
