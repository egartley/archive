...
/* 35 */     pw.println((Game.getPlayer()).mapX);
/* 36 */     pw.println((Game.getPlayer()).mapY);
...
/* 44 */     pw.close();
/*    */     try {
/* 47 */       Game.st.encrypt(Game.getSaveKey(1), file, file);
/* 48 */     } catch (Exception e) {
/* 49 */       e.printStackTrace();
/*    */     } 
/* 52 */     Game.logger.log("Profile 1 saved");
/*    */   }
/*    */ }


/* Location:              E:\Projects\Beyond Origins\BeyondOrigins_0.1.0_2.jar!\com\emgartley\beyondOrigins\main\Profile1.class
