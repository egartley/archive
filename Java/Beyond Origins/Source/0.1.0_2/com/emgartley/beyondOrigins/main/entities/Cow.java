...
/* 147 */     renderX = cowX - (Game.getPlayer()).mapX + Game.playerSpawnX;
/* 148 */     renderY = cowY - (Game.getPlayer()).mapY + Game.playerSpawnY;
/* 149 */     if (this.upCount >= 1 && this.upCount <= 11)
/* 150 */       g.drawImage(ImageManager.cow_up[1], (int)renderX, (int)renderY, 
/* 151 */           32, 32, null); 
/* 153 */     if (this.upCount >= 12 && this.upCount <= 21)
/* 154 */       g.drawImage(ImageManager.cow_up[2], (int)renderX, (int)renderY, 
/* 155 */           32, 32, null); 
/* 157 */     if (this.upCount >= 22 && this.upCount <= 31)
/* 158 */       g.drawImage(ImageManager.cow_up[3], (int)renderX, (int)renderY, 
/* 159 */           32, 32, null); 
/* 161 */     if (this.upCount >= 32 && this.upCount <= 41)
/* 162 */       g.drawImage(ImageManager.cow_up[4], (int)renderX, (int)renderY, 
/* 163 */           32, 32, null); 
/* 165 */     if (this.downCount >= 1 && this.downCount <= 11 && this.down)
/* 166 */       g.drawImage(ImageManager.cow_down[1], (int)renderX, (int)renderY, 
/* 167 */           32, 32, null); 
/* 169 */     if (this.downCount >= 12 && this.downCount <= 21 && this.down)
/* 170 */       g.drawImage(ImageManager.cow_down[2], (int)renderX, (int)renderY, 
/* 171 */           32, 32, null); 
/* 173 */     if (this.downCount >= 22 && this.downCount <= 31 && this.down)
/* 174 */       g.drawImage(ImageManager.cow_down[3], (int)renderX, (int)renderY, 
/* 175 */           32, 32, null); 
/* 177 */     if (this.downCount >= 32 && this.downCount <= 41 && this.down)
/* 178 */       g.drawImage(ImageManager.cow_down[4], (int)renderX, (int)renderY, 
/* 179 */           32, 32, null); 
/* 181 */     if (this.leftCount >= 1 && this.leftCount <= 11 && this.left)
/* 182 */       g.drawImage(ImageManager.cow_left[1], (int)renderX, (int)renderY, 
/* 183 */           32, 32, null); 
/* 185 */     if (this.leftCount >= 12 && this.leftCount <= 21 && this.left)
/* 186 */       g.drawImage(ImageManager.cow_left[2], (int)renderX, (int)renderY, 
/* 187 */           32, 32, null); 
/* 189 */     if (this.leftCount >= 22 && this.leftCount <= 31 && this.left)
/* 190 */       g.drawImage(ImageManager.cow_left[3], (int)renderX, (int)renderY, 
/* 191 */           32, 32, null); 
/* 193 */     if (this.leftCount >= 32 && this.leftCount <= 41 && this.left)
/* 194 */       g.drawImage(ImageManager.cow_left[4], (int)renderX, (int)renderY, 
/* 195 */           32, 32, null); 
/* 197 */     if (this.rightCount >= 1 && this.rightCount <= 11 && this.right)
/* 198 */       g.drawImage(ImageManager.cow_right[1], (int)renderX, 
/* 199 */           (int)renderY, 32, 32, null); 
/* 201 */     if (this.rightCount >= 12 && this.rightCount <= 21 && this.right)
/* 202 */       g.drawImage(ImageManager.cow_right[2], (int)renderX, 
/* 203 */           (int)renderY, 32, 32, null); 
/* 205 */     if (this.rightCount >= 22 && this.rightCount <= 31 && this.right)
/* 206 */       g.drawImage(ImageManager.cow_right[3], (int)renderX, 
/* 207 */           (int)renderY, 32, 32, null); 
/* 209 */     if (this.rightCount >= 32 && this.rightCount <= 41 && this.right)
/* 210 */       g.drawImage(ImageManager.cow_right[4], (int)renderX, 
/* 211 */           (int)renderY, 32, 32, null); 
/* 213 */     if (lastDir == 0 && !this.up && !this.down && !this.left && 
/* 214 */       !this.right)
/* 215 */       g.drawImage(ImageManager.cow_down[1], (int)renderX, (int)renderY, 
/* 216 */           32, 32, null); 
/* 218 */     if (lastDir == 1 && !this.up)
/* 219 */       g.drawImage(ImageManager.cow_up[1], (int)renderX, (int)renderY, 
/* 220 */           32, 32, null); 
/* 222 */     if (lastDir == 2 && !this.down)
/* 223 */       g.drawImage(ImageManager.cow_down[1], (int)renderX, (int)renderY, 
/* 224 */           32, 32, null); 
/* 226 */     if (lastDir == 3 && !this.left)
/* 227 */       g.drawImage(ImageManager.cow_left[1], (int)renderX, (int)renderY, 
/* 228 */           32, 32, null); 
/* 230 */     if (lastDir == 4 && !this.right)
/* 231 */       g.drawImage(ImageManager.cow_right[1], (int)renderX, 
/* 232 */           (int)renderY, 32, 32, null); 
/*     */   }
/*     */ }


/* Location:              E:\Projects\Beyond Origins\BeyondOrigins_0.1.0_2.jar!\com\emgartley\beyondOrigins\main\entities\Cow.class
