...
/* 195 */     if (!isDead) {
/* 196 */       rx = x - (Game.getPlayer()).mapX + Game.playerSpawnX;
/* 197 */       ry = y - (Game.getPlayer()).mapY + Game.playerSpawnY;
...
/* Location:              E:\Projects\Beyond Origins\BeyondOrigins_0.1.0_2.jar!\com\emgartley\beyondOrigins\main\entities\TestDummy.class
